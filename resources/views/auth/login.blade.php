...
<body>
    ...
    <div class="py">
        ...
        <b class="signup"><center>LOG IN AS</center></b>
        <div class="outer-div">
            <div class="inner-div">
                <!-- Content of the first inner div -->
                <a href="{{ route('student.login') }}"><img src="./assets/student.svg" class="student"/></a><br>
                <b> STUDENT</b>
            </div>
            <div class="inner-div">
                <!-- Content of the second inner div -->
                <a href="{{ route('counselor.login') }}"><img src="./assets/Counselor.svg" class="counselor"/></a><br>
                <b>COUNSELOR</b>
            </div>
        </div>
    </div>
